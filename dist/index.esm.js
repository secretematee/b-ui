...
var Icon$c = function (props) {
    var theme = useTheme();
    var primaryColor = theme.isDark ? "#0c0120" : "#e9eaeb";
...
var Icon$e = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 25 24" }, props),
        React.createElement("path", { d: "M19.2 3H5.19995C4.09995 3 3.19995 3.9 3.19995 5V19C3.19995 20.1 4.09995 21 5.19995 21H19.2C20.3 21 21.2 20.1 21.2 19V5C21.2 3.9 20.3 3 19.2 3ZM19.2 19H5.19995V5H19.2V19Z", fill: "#bb80f3" }),
        React.createElement("path", { d: "M11.45 7.72021H6.44995V9.22022H11.45V7.72021Z", fill: "#bb80f3" }),
        React.createElement("path", { d: "M18.2 15.75H13.2V17.25H18.2V15.75Z", fill: "#bb80f3" }),
        React.createElement("path", { d: "M18.2 13.25H13.2V14.75H18.2V13.25Z", fill: "#bb80f3" }),
        React.createElement("path", { d: "M8.19995 18H9.69995V16H11.7V14.5H9.69995V12.5H8.19995V14.5H6.19995V16H8.19995V18Z", fill: "#bb80f3" }),
        React.createElement("path", { d: "M14.29 10.95L15.7 9.54L17.11 10.95L18.17 9.89L16.76 8.47L18.17 7.06L17.11 6L15.7 7.41L14.29 6L13.23 7.06L14.64 8.47L13.23 9.89L14.29 10.95Z", fill: "#bb80f3" })));
};
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 80 80" }, props),
        ...
        React.createElement("defs", null,
            React.createElement("linearGradient", { id: "paint0_linear", x1: "40.9849", y1: "37.4118", x2: "31.978", y2: "71.0261", gradientUnits: "userSpaceOnUse" },
                ...
                React.createElement("stop", { offset: "1", stopColor: "#bb80f3" })),
...
var shadows = {
    ...
    active: "0px 0px 0px 1px #ca92fe, 0px 0px 4px 8px rgba(31, 199, 212, 0.4)",
...
var Icon$H = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React.createElement("path", { d: "M87.93,30.1C86.17,27.8,73.05,23,66.46,23.33c-4.38.21-7.68,1.65-9.81,4.28-3.06,3.79-2.89,9.07-2.43,12.17a49.91,49.91,0,0,0-8.71,14.6c-2-9.33-5.75-14.46-6.94-15.91,1.07-4.19,2.9-15.58-7.39-19.41-9.84-3.65-17.12-3.27-19-1A1.94,1.94,0,0,0,12,20.33a23.84,23.84,0,0,1,.81,2.31C14.57,28,18.19,39.23,25.69,42.45c3.08,1.32,6.45,1.14,10-.54,4.72,8.18,6.39,18.77,6.76,21.5l-.61.33A4.58,4.58,0,0,0,39.57,63,6.42,6.42,0,0,0,34,66.15a7.49,7.49,0,0,0-6.09,1,8.5,8.5,0,0,0-3.47,5,5.11,5.11,0,0,0-3.15,1,6.19,6.19,0,0,0-2.82,4.75A5.72,5.72,0,0,0,24,83.61l39.58.07h0a1,1,0,0,0,.47-.12c.49-.26,4.75-2.64,4.75-5.64a5.71,5.71,0,0,0-5.7-5.68H63a7.73,7.73,0,0,0-2.15-4.43c-1-.89-2.72-1.68-5.43-.8-.63-2.17-1.93-4-6.07-4a6.18,6.18,0,0,0-.86,0c1.4-5.19,4.21-14.52,7.51-19.43,4.95,2.86,10.37,3.21,16.12,1,8.87-3.37,15.74-11.9,16.15-13.21A1.39,1.39,0,0,0,87.93,30.1ZM19.58,25.5,33.16,39.07A25,25,0,0,1,19.58,25.5ZM62.8,33.67a19.11,19.11,0,0,1,8.87-2.3C65.51,32.54,61.59,34.83,59.12,37A12.15,12.15,0,0,1,62.8,33.67Z" })));
};
...
var Icon$U = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React.createElement("path", { d: "M 88.695 40.131 L 71.064 9.593 c -1.739 -3.013 -4.954 -4.869 -8.433 -4.869 H 27.369 c -3.479 0 -6.693 1.856 -8.433 4.869 L 1.305 40.131 c -1.739 3.013 -1.739 6.725 0 9.737 l 17.631 30.538 c 1.739 3.013 4.954 4.869 8.433 4.869 h 35.263 c 3.479 0 6.693 -1.856 8.433 -4.869 l 17.631 -30.538 C 90.435 46.856 90.435 43.144 88.695 40.131 z M 64.345 30.602 l -6.788 31.988 c -0.474 2.273 -1.847 2.817 -3.751 1.767 l -16.677 -12.32 L 56.318 34.72 c 0.842 -0.748 -0.184 -1.112 -1.302 -0.434 l -23.681 14.94 l -10.229 -3.193 c -2.209 -0.676 -2.225 -2.194 0.496 -3.286 l 39.861 -15.37 C 63.282 26.552 65.04 27.816 64.345 30.602 z" })));
};
...
var Icon$Y2 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React.createElement("g", { id: "surface1" },
            React.createElement("path", { d: "M66.1,33.9V66.1M50,46V66.1M33.9,58v8.1m-8,16H74.1a8,8,0,0,0,8-8V25.9a8,8,0,0,0-8-8H25.9a8,8,0,0,0-8,8V74.1A8,8,0,0,0,25.9,82.1Z" }))));
};

var Icon$T7 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React.createElement("g", { id: "surface1" },
            React.createElement("path", { d: "M45.3,27a36.7,36.7,0,0,0-16.5-3.8A36.7,36.7,0,0,0,12.3,27V74.1a38.1,38.1,0,0,1,16.5-3.8A37.4,37.4,0,0,1,50,76.8a37.4,37.4,0,0,1,21.2-6.5,38.1,38.1,0,0,1,16.5,3.8V27a37.7,37.7,0,0,0-33,0V60.9a4.7,4.7,0,1,1-9.4,0Z" }))));
};
...
var Icon$Y44 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "M17.2929 2.29289C17 2.58579 17 3.05719 17 4V17C17 17.9428 17 18.4142 17.2929 18.7071C17.5858 19 18.0572 19 19 19C19.9428 19 20.4142 19 20.7071 18.7071C21 18.4142 21 17.9428 21 17V4C21 3.05719 21 2.58579 20.7071 2.29289C20.4142 2 19.9428 2 19 2C18.0572 2 17.5858 2 17.2929 2.29289Z" }),
        React.createElement("path", { d: "M10 7C10 6.05719 10 5.58579 10.2929 5.29289C10.5858 5 11.0572 5 12 5C12.9428 5 13.4142 5 13.7071 5.29289C14 5.58579 14 6.05719 14 7V17C14 17.9428 14 18.4142 13.7071 18.7071C13.4142 19 12.9428 19 12 19C11.0572 19 10.5858 19 10.2929 18.7071C10 18.4142 10 17.9428 10 17V7Z" }),
        React.createElement("path", { d: "M3.29289 9.29289C3 9.58579 3 10.0572 3 11V17C3 17.9428 3 18.4142 3.29289 18.7071C3.58579 19 4.05719 19 5 19C5.94281 19 6.41421 19 6.70711 18.7071C7 18.4142 7 17.9428 7 17V11C7 10.0572 7 9.58579 6.70711 9.29289C6.41421 9 5.94281 9 5 9C4.05719 9 3.58579 9 3.29289 9.29289Z" })));
};

var Icon$Y42 = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 100 100" }, props),
        React.createElement("path", { d: "M74,34H69.3a10.9,10.9,0,0,0,.7-4A12,12,0,0,0,58,18a11.8,11.8,0,0,0-8,3,11.8,11.8,0,0,0-8-3A12,12,0,0,0,30,30a10.9,10.9,0,0,0,.7,4H26a8,8,0,0,0,0,16H46V46a4,4,0,0,1,8,0v4H74a8,8,0,0,0,0-16ZM46,34H42a4,4,0,1,1,4-4Zm12,0H54V30a4,4,0,1,1,4,4Z" }),
        React.createElement("path", { d: "M22,74a8,8,0,0,0,8,8H46V54H22Z" }),
        React.createElement("path", { d: "M54,82H70a8,8,0,0,0,8-8V54H54Z" })));
};
...
var socials = [
    {
        label: "Telegram",
        icon: "TelegramIcon",
		href: "https://t.me/ButterflyAVAX",
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/ButterflyDeFi",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#d1a9ff", background: "#0d0122", backgroundDisabled: "#0c0120", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#0c172e", primaryDark: "#ca92fe", tertiary: "#0c0120", text: "#d1a9ff", textDisabled: "#d1a9ff", textSubtle: "#d1a9ff", borderColor: "#524B63", card: "#0f0028", gradients: {
